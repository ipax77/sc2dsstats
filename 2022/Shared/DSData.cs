...
namespace sc2dsstats._2022.Shared
{
    ...
    {
        public static List<DsJsonEnt> Units { get; set; } = new List<DsJsonEnt>();
        public static List<DsJsonEnt> Upgrades { get; set; } = new List<DsJsonEnt>();
        public static List<DsJsonObjective> Objectives { get; set; } = new List<DsJsonObjective>();

        public static void Init(string rootDir = "/data/")
        {
        ...
        public static List<Commander> GetStdCommanders => Enum.GetValues<Commander>().Where(x => (int)x <= 3).ToList();
