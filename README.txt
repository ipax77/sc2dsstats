...
If you are using a language with non Latin alphabet make sure you save the config.txt file in UTF-8 (https://www.hesk.com/knowledgebase/index.php?article=87). 
