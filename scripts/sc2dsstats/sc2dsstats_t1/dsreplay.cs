...
namespace sc2dsstats
{
    ...
    class dsstats
    {
        ...
        public virtual void AddGame(string race, string opp_race)
        {
            dsstats_race cmdr = new dsstats_race();
            cmdr = this.objRace(race);
            this.GAMES++;
            cmdr.RGAMES++;
            ...
            cmdr_opp = cmdr_vs.objRaceVS(opp_race);
            cmdr_opp.RGAMES++;
        }

        public virtual void AddWin(string race, string opp_race)
        {
            dsstats_race cmdr = new dsstats_race();
            cmdr = this.objRace(race);
            this.WINS++;
    ...
    class dsdps : dsstats_race
    {
        ...
        public void AddGame(dsplayer pl, dsplayer opp)
        {
            dsstats_race cmdr = new dsstats_race();
        ...
        public void AddWin(dsplayer pl, dsplayer opp)
        {
            dsstats_race cmdr = new dsstats_race();
            cmdr = this.objRace(pl.RACE);
            this.WINS++;
