...
{
    public partial class Gdsl2Component : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected ILogger<Gdsl2Component> _logger { get; set; }
        ...
        private PickbanStatus pickBanStatus;
        ...
        private async Task Lock()
        {
            ...
            await hubConnection.SendAsync("Lock", info);
        }
